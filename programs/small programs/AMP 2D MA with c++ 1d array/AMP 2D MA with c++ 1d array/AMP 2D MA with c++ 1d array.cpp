// AMP 2D MA with c++ 1d array.cpp : Defines the entry point for the console application.
//
...
#pragma endregion
	...
	std::ofstream outfile("AMP_2D_MA_with_C++_1d_array.txt");
	outfile << "AMP 2D MA with C++ 1d array  mean, sdev" << std::endl;
